             ...
             OPEN prod_cursor;
              ...
              -- Validate the quantity remaining
                ...
                AND stk_loc_code=v_loc_code;
                   -- SET v_msg='v_pdt_code== '+v_pdt_code+' v_loc_code== '+v_loc_code;
                ...
                IF v_remaining_qty<v_qty THEN
                   ...
                   select concat('No enough stock for ',v_prod_description) into v_rtnVal;
                  --  signal sqlstate '45000' set message_text = v_rtnVal; 
                  signal sqlstate '01000' set message_text = v_rtnVal; 
                END IF;
