 ...
 * logged out.
 */
Ext.define('InventoryApp.util.SessionMonitor', {
  singleton: true,
  ...
  window: Ext.create('Ext.window.Window', {
    ...
    buttons: [{
      ...
      handler: function() {
        Ext.TaskManager.stop(InventoryApp.util.SessionMonitor.countDownTask);
        InventoryApp.util.SessionMonitor.window.hide();
