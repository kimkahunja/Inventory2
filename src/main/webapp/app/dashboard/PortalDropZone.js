 ...
 */
Ext.define('InventoryApp.dashboard.PortalDropZone', {
    extend: 'Ext.dd.DropTarget',

    constructor: function(portal, cfg) {
        this.portal = portal;
        Ext.dd.ScrollManager.register(portal.body);
        InventoryApp.dashboard.PortalDropZone.superclass.constructor.call(this, portal.body, cfg);
    ...
    unreg: function() {
        ...
        InventoryApp.dashboard.PortalDropZone.superclass.unreg.call(this);
    }
});
